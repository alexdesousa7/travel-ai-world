...
class ActivityService:
    ...
    async def get_activity_by_id(self, activity_id: uuid.UUID | str) -> Optional[Activity]:
    ...
    async def create_activity(self, activity_in: ActivityCreate, **kwargs: Any) -> Activity:
    ...
    async def update_activity(self, db_obj: Activity, activity_in: ActivityUpdate) -> Activity:
